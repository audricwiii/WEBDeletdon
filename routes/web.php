...
Route::get('/product_insert_form', [StoreController::class, 'prouct_insert_form'])->name('product_insert_form');
Route::post('/product_insert', [StoreController::class, 'insert_product'])->name('insert_product');
...
Route::middleware('auth')->group(function(){
    ...
    Route::get('/store', [StoreController::class, 'show'])->name('store');
    Route::get('/product/insert-form', [StoreController::class, 'prouct_insert_form'])->name('product_insert_form');
...
Route::post('/add-to-cart/{product_id}', [StoreController::class, 'add_to_cart'])->name('add_to_cart')->middleware('auth'); 
Route::get('/cart', [StoreController::class, 'view_cart'])->name('view_cart');
Route::patch('/cart/update/{product_id}', [StoreController::class, 'update_cart'])->name('update_cart');
Route::delete('/cart/remove/{product_id}', [StoreController::class, 'remove_from_cart'])->name('remove_from_cart');
