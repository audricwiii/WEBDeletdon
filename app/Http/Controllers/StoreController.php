...
class StoreController extends Controller
{
    ...
    {
        return view('store', ['products' => Product::where('stock', '>', 0)->with([ 'products_category' ])->get()]);
    }
    public function prouct_insert_form  ()
    {
        return view('products.insert-form',['product_categories' => ProductCategory::get()]);
    }
    ...
    public function product_edit_form($product_id){
        $product = Product::findOrFail($product_id);
        return view('products.edit-form', ['product' => $product, 'product_categories' => ProductCategory::get()]);
    }
